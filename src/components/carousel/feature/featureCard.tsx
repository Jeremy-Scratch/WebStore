...
export default function Card({ deepGameInfo }: featureCardProps) {
    ...
    return (
        <a href="" className="relative z-1 block grow-0 shrink w-[28vw] ">
            <div className="group block relative max-w-full z-2 transition-transform ease-in-out duration-200 hover:scale-105">
                ...
                <video autoPlay playsInline loop muted preload='' className="absolute top-[50%] left-[50%] transform-[translate(-50%,-50%)] object-cover aspect-video z-3 w-full h-auto opacity-0 bg-black transition-opacity duration-600 hover:opacity-100">
